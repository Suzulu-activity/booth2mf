...
const columns = [
    ...
    { field: 'dr_sup', headerName: '借方取引先', sortable: false, width: 100 },
    ...
    { field: 'cr_sup', headerName: '貸方取引先', sortable: false, width: 100 },
...
const transformCsv = (rawData: any, settings: { [key: string]: any; }) => {
    ...
    for(var row of salesList) {
        ...
        journals.push({
            ...
            cr_amount: '',
            cr_tax: '',
            remarks: 'BOOTH決済手数料 BOOTH注文番号: ' + row['no'],
            note: '',
            tag: '',
            type: '',
            adjust: '',
        ...
        if (row['outsourcing_factory'] !== 0) {
            ...
            journals.push({
                ...
                dr_dept: '',
                dr_sup: 'ピクシブ株式会社',
                dr_amount: row['outsourcing_factory'],
                dr_tax: '',
                cr_sbj1: '',
                cr_sbj2: '',
                cr_taxg: '',
